...
namespace MyBlog.WebUI.Areas.Administrator.TagHelpers
{
	...
	public class TagPagingTagHelper : TagHelper
	{
		...
		public override void Process(TagHelperContext context, TagHelperOutput output)
		{
			...
			for (int i = 1; i <= PageCount; i++)
			{
				...
				stringBuilder.AppendFormat("<a href='/administrator/tags?page={0}&search={1}'class='page-link page-link-test'>{2}</a>", i, SearchTag, i);
