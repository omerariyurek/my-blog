...
{
	[HtmlTargetElement("post-paging")]
	public class PostPagingTagHelper : TagHelper
	{
		...
		public override void Process(TagHelperContext context, TagHelperOutput output)
		{
			...
			for (int i = 1; i <= PageCount; i++)
			{
				...
				stringBuilder.AppendFormat("<a href='/administrator/posts?page={0}&search={1}'class='page-link page-link-test'>{2}</a>", i, SearchPost, i);
